...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: 't0',
    name: 'Dr. Keza Aline',
    role: 'Lead Dentist & Managing Director',
    organization: 'KigaliCare Dental Clinic',
    industry: 'Healthcare',
    avatar: 'https://images.unsplash.com/photo-1594824813566-88855ce78347?auto=format&fit=crop&w=250&q=80',
  ...
  },
  {
    ...
    organization: 'Apex National Health Network',
    industry: 'Healthcare',
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=250&q=80',
    content: 'Luminex Technologies completely modernized our hospital records across 14 facilities. Patient check-in wait times dropped by 72% within 60 days of launch. Their engineering precision is unmatched in the region.',
    metric: '-72%',
  ...
  },
  {
    ...
    organization: 'Bank of Infrastructure & Trade',
    industry: 'Banking',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=250&q=80',
    content: 'When we needed a core treasury engine capable of handling billions of Rwandan Francs daily, Luminex delivered a flawless solution. Their adherence to financial security and zero-downtime deployment set a new standard.',
    metric: '12B RWF',
